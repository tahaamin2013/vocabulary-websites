...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        locked: "bg-primary text-primary-foreground hover:bg-primary/90 border-neutral-400 border-b-4 active:border-b-0",
        default: "bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-slate-100 text-slate-500",
        primary: "bg-primary text-primary-foreground hover:bg-primary/90 border-[#ff7a42] border-b-4 active:border-b-0",
        primaryOutline: "bg-white text-blue hover:bg-slate-100",
        secondary: "bg-primary text-primary-foreground hover:bg-primary/90 border-[#ff7a42] border-b-4 active:border-b-0",
        secondaryOutline: "bg-white text-primary hover:bg-slate-100",
        ...
        sidebarOutline: "bg-blue/15 text-blue border-blue border-2 hover:bg-blue/20 transition-none"
      },
      size: {
